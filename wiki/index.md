...
- [[Environment|topics/environment.md]] - `node/jsdom/happy-dom` 选择、Browser Mode 区分、`environmentOptions` 入口、`test.env` / `define` 边界，以及 Browser Mode 下的 React 组件测试库选型。`updated: 2026-05-22` `sources: 11`
